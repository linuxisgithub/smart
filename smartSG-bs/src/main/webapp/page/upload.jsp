...
if("${param.changeIcon}" != ""){
	fileImg1 = "<img src='${ctx }/images/icons/accessory_icon1.png'/>";//无
	fileImg2 = "<img src='${ctx }/images/icons/accessory_icon2.png'/>";//有
}
...
function returnFiles() {
	...
	if(typeof(isFrame) != "undefined" && (isFrame == true || isFrame == "true")) {
...
$(function () {
    ...
    var defaultImg = "<img src='${ctx}/images/filePic.png' width='80' height='56'/>";
    $("#fileupload").data("names",[]);//初始化names空数组
    if(typeof(isFrame) != "undefined" && (isFrame == true || isFrame == "true")) {
    	var _fileInfos = parent.$('#' + fileInfos).val();
    	if(_fileInfos != "") {
