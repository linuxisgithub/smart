 	...
 	DialogBox.prototype = {	
 		...
 		create: function(element){
 			...
 			if(!title){
 				...
 				if(!hasClose){
					dialogHTML[0] = '<section class="dialog-box"><div class="dialog-box-container"><div class="dialog-box-title"><h3 style="font-size: 12px;">'+ title + '</h3></div><div class="dialog-box-content"></div>';
 				}else{					
 					dialogHTML[0] = '<section class="dialog-box"><div class="dialog-box-container"><div class="dialog-box-title"><h3 style="font-size: 12px;">'+ title + '</h3><span class="dialog-box-close">×</span></div><div class="dialog-box-content"></div>';
 				}
 			}
 		...
 		setStyle: function(){
 			...
 			$dialog.css({
 				...
 				'margin-left': function(){
 					...
 					if(only_im != undefined && only_im == 0) {
 						width = width - 220;
 					}
