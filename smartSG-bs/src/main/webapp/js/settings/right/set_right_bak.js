$(function() {
	...
	function setDefault() {
		if(resetFlag == true) {
			$("#kind_" + default_kind).attr("checked","checked");
			if(default_kind == 2) {
				$("#dept_shade").hide();
				$("#user_shade").show();
	...
	function appendDept(item) {
		...
		deptHtml += '<label>';
		deptHtml += '<input class="person-checkbox" type="checkbox" name="dept-one" data-eid="'+item.eid+'" id="dept_'+item.eid+'"><span class="person-checkboxInput"></span>';
		deptHtml += '</label>';
		deptHtml += '</div>';
		deptHtml += '</li>';
	...
	function appendUser(item) {
		...
		html += '<label>';
		html += '<input class="person-checkbox dept_'+item.deptId+'" type="checkbox" name="user-one" data-deptId="'+item.deptId+'" data-eid="'+item.eid+'" id="user_'+item.eid+'"><span class="person-checkboxInput"></span>';
		html += '</label>';
		html += '</div>';
		html += '</li>';
