...
public class EncrypDES {
	...
	public static final String KEY = "112233";
	...
	public static String enCrypt(String id) throws Exception {
		...
		/*byte[] byteRe = enCrypt(id, KEY);

		// 加密过的二进制数组转化成16进制的字符串
		String encrytStr = EncrypDES.parseByte2HexStr(byteRe);*/
...
/*
		byte[] encrytByte = EncrypDES.parseHexStr2Byte(id);

		return EncrypDES.deCrypt(encrytByte, KEY);*/
